...
namespace AcuantMobileSDK
{
	...
	interface AcuantCardProcessRequestOptions
	{
	...
	[BaseType(typeof(AcuantCardResult))]
	interface AcuantMedicalInsuranceCard
	{
	...
	[BaseType(typeof(AcuantCardResult))]
	interface AcuantDriversLicenseCard
	{
		// @property (nonatomic, strong) NSString * dateOfBirth4;
		[Export("dateOfBirth4", ArgumentSemantic.Strong)]
		string DateOfBirth4 { get; set; }
	...
	[Protocol, Model]
	[BaseType(typeof(NSObject))]
	interface AcuantMobileSDKControllerCapturingDelegate
	{
		// @required -(void)didCaptureCropImage:(UIImage *)cardImage scanBackSide:(BOOL)scanBackSide;
		[Abstract]
		[Export("didCaptureCropImage:scanBackSide:")]
		void DidCaptureCropImage(UIImage cardImage, bool scanBackSide);
	...
	interface AcuantMobileSDKController
	{
		...
		AcuantMobileSDKController InitAcuantMobileSDKWithLicenseKey(string key, NSObject @delegate);
	...
	[Protocol, Model]
	[BaseType(typeof(NSObject))]
	interface AcuantFacialCaptureDelegate
	{
		// @required -(void)didFinishFacialRecognition:(UIImage *)image;
		[Abstract]
		...
		// @required -(void)didTimeoutFacialRecognition:(UIImage *)lastImage;
		[Abstract]
		[Export("didTimeoutFacialRecognition:")]
		void DidTimeoutFacialRecognition(UIImage lastImage);

		// @required -(UIImage *)imageForFacialBackButton;
		[Abstract]
		[Export("imageForFacialBackButton")]
		//[Verify(MethodToProperty)]
		UIImage ImageForFacialBackButton { get; }
		...
		// @required -(CGRect)frameWhereMessageToBeShownAfterFaceRectangleAppears;
		[Abstract]
		[Export("frameWhereMessageToBeShownAfterFaceRectangleAppears")]
		//[Verify(MethodToProperty)]
		CGRect FrameWhereMessageToBeShownAfterFaceRectangleAppears { get; }
	}
	...
	interface AcuantFacialRecognitionViewController
	{
		...
		NSObject PresentFacialCaptureInterfaceWithDelegate(AcuantFacialCaptureDelegate @delegate, AcuantMobileSDKController sdkController, UIViewController parentVC, bool cancelVisible, string watermarkText, NSAttributedString message, CGRect rect);
	}

	// @interface AcuantFacialData : AcuantCardResult
	[BaseType(typeof(AcuantCardResult))]
	interface AcuantFacialData
	{
		...
		[Export("facialMatchConfidenceRating", ArgumentSemantic.Strong)]
		string FacialMatchConfidenceRating { get; set; }
	}
}
